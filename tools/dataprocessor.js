 ...
 * ******************************************************************/
class DataProcessor {
  /* moved to constructor - this syntax is experimental 
  data = [];
  todayColumn = '';
  dataColums;
  summSpec;
  ...
  */
  ...
  constructor() {
    this.data = [];
    this.todayColumn = '';
    this.dataColums = null;
    this.summSpec = null;
    this.rollupTrend = null;
  }
